...
description: "Learn how ai-mem works automatically in the background"
---

# Getting Started with ai-mem

## Automatic Operation

ai-mem works automatically once installed. No manual intervention required!

### The Full Cycle

1. **Start your AI tool** - Context from previous sessions appears automatically
2. **Work normally** - Every tool execution is captured
3. **Session ends** - Stop hook automatically generates and saves a summary
