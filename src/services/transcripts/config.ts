...
export const DEFAULT_CONFIG_PATH = join(homedir(), '.ai-mem', 'transcript-watch.json');
export const DEFAULT_STATE_PATH = join(homedir(), '.ai-mem', 'transcript-watch-state.json');
