  ...
  return (
    <div className="header">
      <h1>
        ...
        <span className="logo-text">ai-mem</span>
      </h1>
      <div className="status">
        ...
        <a
          href="https://github.com/rendivs925/ai-mem#readme"
          target="_blank"
        ...
        <a
          href="https://github.com/rendivs925/ai-mem"
          target="_blank"
          rel="noopener noreferrer"
          className="icon-link"
        ...
        <a
          href="https://github.com/rendivs925/ai-mem/issues"
          target="_blank"
          rel="noopener noreferrer"
          className="icon-link"
        ...
        <GitHubStarsButton username="rendivs925" repo="ai-mem" />
        <select
          value={currentFilter}
