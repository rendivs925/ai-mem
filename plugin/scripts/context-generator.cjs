"use strict";var Vt=Object.create;var $=Object.defineProperty;var Kt=Object.getOwnPropertyDescriptor;var Jt=Object.getOwnPropertyNames;var zt=Object.getPrototypeOf,Qt=Object.prototype.hasOwnProperty;var Zt=(r,e)=>{for(var t in e)$(r,t,{get:e[t],enumerable:!0})},Ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Jt(e))!Qt.call(r,n)&&n!==t&&$(r,n,{get:()=>e[n],enumerable:!(s=Kt(e,n))||s.enumerable});return r};var O=(r,e,t)=>(t=r!=null?Vt(zt(r)):{},Ae(e||!r||!r.__esModule?$(t,"default",{value:r,enumerable:!0}):t,r)),es=r=>Ae($({},"__esModule",{value:!0}),r);var Us={};Zt(Us,{generateContext:()=>Oe});module.exports=es(Us);var Gt=O(require("path"),1),Wt=require("os"),Ht=require("fs");var Ue=require("bun:sqlite");var S=require("path"),ce=require("os"),P=require("fs");var De=require("url");var v=require("fs"),D=require("path"),Ne=require("os"),ie=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ie||{}),Ce=(0,D.join)((0,Ne.homedir)(),".ai-mem"),ae=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,D.join)(Ce,"logs");(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,D.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,D.join)(Ce,"settings.json");if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(JSON.parse(t).AI_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ie[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):l=" "+this.formatData(o));let u="";if(n){let{sessionId:T,memorySessionId:h,correlationId:b,...g}=n;Object.keys(g).length>0&&(u=` {${Object.entries(g).map(([E,y])=>`${E}=${y}`).join(", ")}}`)}let f=`[${a}] [${i}] [${c}] ${d}${s}${u}${l}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,f+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=d?`${d[1].split("/").pop()}:${d[2]}`:"unknown",u={...s,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},p=new ae;var ns={};function ts(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,De.fileURLToPath)(ns.url))}var ss=ts();function rs(){if(process.env.AI_MEM_DATA_DIR)return process.env.AI_MEM_DATA_DIR;let r=(0,S.join)((0,ce.homedir)(),".ai-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.AI_MEM_DATA_DIR)return n.AI_MEM_DATA_DIR}}catch{}return r}var I=rs(),A=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,ce.homedir)(),".claude"),Bs=(0,S.join)(A,"plugins","marketplaces","thedotmack"),Xs=(0,S.join)(I,"archives"),Gs=(0,S.join)(I,"logs"),Ws=(0,S.join)(I,"trash"),Hs=(0,S.join)(I,"backups"),qs=(0,S.join)(I,"modes"),Ys=(0,S.join)(I,"settings.json"),Le=(0,S.join)(I,"claude-mem.db"),Vs=(0,S.join)(I,"vector-db"),Ks=(0,S.join)(I,"observer-sessions"),Js=(0,S.join)(A,"settings.json"),zs=(0,S.join)(A,"commands"),Qs=(0,S.join)(A,"CLAUDE.md");function we(r){(0,P.mkdirSync)(r,{recursive:!0})}function xe(){return(0,S.join)(ss,"..")}var ke=require("crypto");var os=3e4;function C(r,e,t){return(0,ke.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function F(r,e,t){let s=t-os;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var j=class{db;constructor(e=Le){e!==":memory:"&&we(I),this.db=new Ue.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA busy_timeout = 5000"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:a,concepts:i,files:c}=t,d=s==="date_asc"?"ASC":"DESC",l=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),f=[...e],T=[];if(o&&(T.push("project = ?"),f.push(o)),a)if(Array.isArray(a)){let g=a.map(()=>"?").join(",");T.push(`type IN (${g})`),f.push(...a)}else T.push("type = ?"),f.push(a);if(i){let g=Array.isArray(i)?i:[i],_=g.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");f.push(...g),T.push(`(${_.join(" OR ")})`)}if(c){let g=Array.isArray(c)?c:[c],_=g.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");g.forEach(E=>{f.push(`%${E}%`,`%${E}%`)}),T.push(`(${_.join(" OR ")})`)}let h=T.length>0?`WHERE id IN (${u}) AND ${T.join(" AND ")}`:`WHERE id IN (${u})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${h}
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,a){let i=a??Date.now(),c=new Date(i).toISOString(),d=C(e,s.title,s.narrative),l=F(this.db,d,i);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let f=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,c,i);return{id:Number(l.lastInsertRowid),createdAtEpoch:i}}storeObservations(e,t,s,n,o,a=0,i){let c=i??Date.now(),d=new Date(c).toISOString();return this.db.transaction(()=>{let u=[],f=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let h of s){let b=C(e,h.title,h.narrative),g=F(this.db,b,c);if(g){u.push(g.id);continue}let _=f.run(e,t,h.type,h.title,h.subtitle,JSON.stringify(h.facts),h.narrative,JSON.stringify(h.concepts),JSON.stringify(h.files_read),JSON.stringify(h.files_modified),o||null,a,b,d,c);u.push(Number(_.lastInsertRowid))}let T=null;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let _ of s){let E=C(e,_.title,_.narrative),y=F(this.db,E,l);if(y){T.push(y.id);continue}let ne=h.run(e,t,_.type,_.title,_.subtitle,JSON.stringify(_.facts),_.narrative,JSON.stringify(_.concepts),JSON.stringify(_.files_read),JSON.stringify(_.files_modified),i||null,c,E,u,l);T.push(Number(ne.lastInsertRowid))}let b;if(n){let E=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,i||null,c,u,l);b=Number(E.lastInsertRowid)}return this.db.prepare(`
    ...
    `).all(...d)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,a=s==="date_asc"?"ASC":"DESC",i=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),d=[...e],l=o?"AND s.project = ?":"";return o&&d.push(o),this.db.prepare(`
      ...
      ${i}
    `).all(...d)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let a=o?"AND project = ?":"",i=o?[o]:[],c,d;if(e!==null){let g=`
      ...
      `,_=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let E=this.db.prepare(g).all(e,...i,s+1),y=this.db.prepare(_).all(e,...i,n+1);if(E.length===0&&y.length===0)return{observations:[],sessions:[],prompts:[]};c=E.length>0?E[E.length-1].created_at_epoch:t,d=y.length>0?y[y.length-1].created_at_epoch:t}catch(E){return p.error("DB","Error getting boundary observations",void 0,{error:E,project:o}),{observations:[],sessions:[],prompts:[]}}}else{let g=`
      ...
      `,_=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let E=this.db.prepare(g).all(t,...i,s),y=this.db.prepare(_).all(t,...i,n+1);if(E.length===0&&y.length===0)return{observations:[],sessions:[],prompts:[]};c=E.length>0?E[E.length-1].created_at_epoch:t,d=y.length>0?y[y.length-1].created_at_epoch:t}catch(E){return p.error("DB","Error getting boundary timestamps",void 0,{error:E,project:o}),{observations:[],sessions:[],prompts:[]}}}let l=`
      SELECT *
      FROM observations
    ...
    `,T=this.db.prepare(l).all(c,d,...i),h=this.db.prepare(u).all(c,d,...i),b=this.db.prepare(f).all(c,d,...i);return{observations:T,sessions:h.map(g=>({id:g.id,memory_session_id:g.memory_session_id,project:g.project,request:g.request,completed:g.completed,next_steps:g.next_steps,created_at:g.created_at,created_at_epoch:g.created_at_epoch})),prompts:b.map(g=>({id:g.id,content_session_id:g.content_session_id,prompt_number:g.prompt_number,prompt_text:g.prompt_text,project:g.project,created_at:g.created_at,created_at_epoch:g.created_at_epoch}))}}getPromptById(e){return this.db.prepare(`
      SELECT
        p.id,
    ...
    `).run(e)}async deleteMemory(e){this.db.query("DELETE FROM observations WHERE id = ?").run(e)}async storeMemory(e){let t=new Date(e.metadata.createdAt).toISOString(),s=C(e.sessionId,e.content.title,e.content.narrative);this.ensureSession(e.sessionId,e.project,e.metadata.createdAt);let n=this.db.query(`
      INSERT INTO observations (
...
`}function wt(r,e,t,s){let n=[];return s?n.push(...bt(r)):n.push(...it(r)),s?n.push(...St()):n.push(...at()),s?n.push(...yt()):n.push(...ct()),s?n.push(...Rt()):n.push(...dt()),Z(t)&&(s?n.push(...It(e,t)):n.push(...lt(e,t))),n}var Ie=O(require("path"),1);function re(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return p.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function Me(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ve(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function kt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function xt(r,e){return Ie.default.isAbsolute(r)?Ie.default.relative(e,r):r}function Ut(r,e,t){let s=re(r);if(s.length>0)return xt(s[0],e);if(t){let n=re(t);if(n.length>0)return xt(n[0],e)}return"General"}function As(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=kt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),a=new Date(n[0]).getTime();return o-a});return new Map(t)}function $t(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?re(r.facts).join(`
`):null}function Cs(r,e,t,s){let n=[];n.push(...mt(r));let o="";for(let a of e)if(a.type==="summary"){o="";let i=a.data,c=Me(i.displayTime);n.push(...Et(i,c))}else{let i=a.data,c=ve(i.created_at),l=c!==o?c:"";if(o=c,t.has(i.id)){let f=$t(i,s);n.push(..._t(i,l,f,s))}else n.push(pt(i,l,s))}return n}function Ns(r,e,t,s,n){let o=[];o.push(...Mt(r));let a=null,i="";for(let c of e)if(c.type==="summary"){a=null,i="";let d=c.data,l=Me(d.displayTime);o.push(...Ct(d,l))}else{let d=c.data,l=Ut(d.files_modified,n,d.files_read),u=ve(d.created_at),f=u!==i;i=u;let T=t.has(d.id);if(l!==a&&(o.push(...vt(l)),a=l),T){let h=$t(d,s);o.push(...At(d,u,f,h,s))}else o.push(Ot(d,u,f,s))}return o.push(""),o}function Ds(r,e,t,s,n,o){return o?Ns(r,e,t,s,n):Cs(r,e,t,s)}function Pt(r,e,t,s,n){let o=[],a=As(r);for(let[i,c]of a)o.push(...Ds(i,c,e,t,s,n));return o}function Ft(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function jt(r,e){let t=[];return e?(t.push(...U("Investigated",r.investigated,m.blue)),t.push(...U("Learned",r.learned,m.yellow)),t.push(...U("Completed",r.completed,m.green)),t.push(...U("Next Steps",r.next_steps,m.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function Bt(r,e){return e?Nt(r):gt(r)}function Xt(r,e,t){return!Z(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Dt(r.totalDiscoveryTokens,r.totalReadTokens):ft(r.totalDiscoveryTokens,r.totalReadTokens)}var Ls=Gt.default.join((0,Wt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ws(){try{return new j}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ht.unlinkSync)(Ls)}catch(e){p.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return p.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function xs(r,e){return e?Lt(r):Tt(r)}function ks(r,e,t,s,n,o,a,i,c){let d=[],l=he(e);d.push(...wt(r,l,o,c));let u=t.slice(0,o.sessionCount),f=rt(u,t),T=Re(e,f),h=nt(e,o.fullObservationCount);d.push(...Pt(T,h,o,a,c));let b=t[0],g=e[0];if(Ft(o,b,g)&&d.push(...jt(b,c)),s.length>0){d.push(c?"Committed Project Memory":"## Committed Project Memory"),d.push(""),d.push("Use these as stable project knowledge and established workflows. Prefer them over raw historical detail unless you need provenance."),d.push("");for(let E of s.slice(0,6))d.push(`- [${E.tier}] ${E.title}: ${E.narrative.slice(0,180)}`);d.push("")}if(n.length>0){d.push(c?"Relevant Episodic Evidence":"## Relevant Episodic Evidence"),d.push("");for(let E of n.slice(0,3))d.push(`- [${E.tier}] ${E.title}: ${E.narrative.slice(0,140)}`);d.push("")}let _=ye(e,o,i,a);return d.push(...Bt(_,c)),d.push(...Xt(l,o,c)),d.join(`
`).trimEnd()}async function Oe(r,e=!1){let t=ge(),s=r?.cwd??process.cwd(),n=Ke(s),o=n.canonical,a=r?.projects||n.allProjects;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let i=ws();if(!i)return"";try{let c=qe(i.db);await c.initialize();let d=a.length>1?tt(i,a,t):be(i,o,t),l=a.length>1?st(i,a,t):Se(i,o,t),u=await c.retrieveMemories("",{projects:a,tiers:["semantic","procedural"]},8).then(h=>h.map(b=>({tier:b.cmu.tier,title:b.cmu.content.title,narrative:b.cmu.content.narrative}))),f=await c.retrieveMemories("",{projects:a,tiers:["episodic"]},4).then(h=>h.map(b=>({tier:b.cmu.tier,title:b.cmu.content.title,narrative:b.cmu.content.narrative})));return d.length===0&&l.length===0&&u.length===0&&f.length===0?xs(o,e):ks(o,d,l,u,f,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
